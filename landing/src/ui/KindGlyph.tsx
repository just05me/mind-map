import type { KindId } from '../content/tokens'

/** Line glyphs for card nodes (copy of the app's KindGlyph). viewBox 0 0 24 24. */
const GLYPHS: Record<KindId, string> = {
...
export function KindGlyph({ kind, size = 18 }: { kind: KindId; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
