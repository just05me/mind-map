import type { NodeShape } from '../content/tokens'

/** Signature silhouettes for shape nodes, a copy of the app's NodeArt (76×58). */
export function NodeArt({ shape, color }: { shape: NodeShape; color: string }) {
  ...
  switch (shape) {
    ...
    case 'cloud':
      return (
        <svg {...common} aria-hidden>
          <path d="M24 47a13 13 0 010-26 16 16 0 0130.5-4A11 11 0 0154 47z" fill={fill} />
        </svg>
      )
    case 'circle':
      return (
